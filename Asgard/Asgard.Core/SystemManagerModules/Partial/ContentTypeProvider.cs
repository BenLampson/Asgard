...
namespace Asgard.Core.SystemManagerModules.Partial
{
    ...
    {
        private static readonly Dictionary<string, string> _allTypes = new(StringComparer.OrdinalIgnoreCase)
        {
                { ".323", "text/h323" },
                { ".3g2", "video/3gpp2" },
                { ".3gp2", "video/3gpp2" },
        ...
        public bool TryGetContentType(string subpath, [MaybeNullWhen(false)] out string contentType)
        {
            ...
            if (_allTypes.TryGetValue(extension, out contentType))
            {
                return true;
            }
            contentType = "application/octet-stream";
