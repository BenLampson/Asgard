using Asgard.Core.ContextModules.AspNet.Auth.Models;
using Asgard.Core.ContextModules.AspNet.Auth.Results;
using Asgard.Core.ContextModules.Logger.AbsInfos;

using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc.Filters;

namespace Asgard.Core.ContextModules.AspNet.Auth.Filter
{
    /// <summary>
    /// 容器权限过滤器
    /// </summary>
    public class AuthFilter : IAuthorizationFilter
    {
        ...
        /// 日志
        /// </summary>
        private readonly AbsLogger<AuthFilter> _logger;
        ...
        /// 
        /// </summary> 
        public AuthFilter(string[] roles, string[] posts, string[] customData, bool needsTenantID, AsgardContext context, AbsLogger<AuthFilter> logger)
        {
            _roles = roles;
            _logger = logger;
            _context = context;
