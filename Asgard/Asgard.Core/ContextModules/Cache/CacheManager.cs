...
namespace Asgard.Core.ContextModules.Cache
{
    /// <summary>
    /// 缓存管理对象
    /// </summary>
    public class CacheManager
    {
        ...
        public CacheManager(LoggerProvider loggerProvider)
        {
        ...
        public void Set<T>(string key, T data, CacheItemSettings settings)
        {
            try
            {
                ...
                {
                    realStringData = JsonSerializer.Serialize(data, CommonSerializerOptions.CamelCaseChineseNameCaseInsensitive);
                }
        ...
        public void SetString(string key, string value, CacheItemSettings settings)
        {
